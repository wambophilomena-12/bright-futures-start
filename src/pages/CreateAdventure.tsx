...
                    id="place"
                    required
                    className="pl-10 rounded-none" // ADDED rounded-none
...
                >
                  {/* ADDED rounded-none to the Trigger */}
                  <SelectTrigger className="rounded-none">
                    <SelectValue />
                  </SelectTrigger>
                  {/* SelectContent might also need global style override if it has a border-radius */}
...
                    className="rounded-none" // ADDED rounded-none
                  />
                  <Button type="button" variant="outline" onClick={getCurrentLocation} className="rounded-none"> {/* ADDED rounded-none */}
...
                <Button type="button" size="sm" onClick={addActivity} className="rounded-none">Add Activity</Button> {/* ADDED rounded-none */}
              </div>
...
                    />
                    {activities.length > 1 && (
                      <Button type="button" size="sm" variant="destructive" onClick={() => removeActivity(index)} className="rounded-none">×</Button> {/* ADDED rounded-none */}
                    )}
                  </div>
                </div>
              ))}
...
                <Button type="button" size="sm" onClick={addFacility} className="rounded-none">Add Facility</Button> {/* ADDED rounded-none */}
              </div>
...
                    />
                    {facilities.length > 1 && (
                      <Button type="button" size="sm" variant="destructive" onClick={() => removeFacility(index)} className="rounded-none">×</Button> {/* ADDED rounded-none */}
                    )}
                  </div>
                </div>
              ))}
...
                        alt={`Preview ${index + 1}`}
                        className="w-full h-20 object-cover rounded-none" // MODIFIED: ADDED rounded-none
                      />
                      <Button
                        type="button"
                        size="sm"
                        variant="destructive"
                        className="absolute top-0 right-0 h-6 w-6 p-0 rounded-none" // ADDED rounded-none
...
              <Button type="submit" disabled={loading || uploading || galleryImages.length === 0} className="flex-1 rounded-none"> {/* ADDED rounded-none */}
                {uploading ? "Uploading Images..." : loading ? "Submitting..." : "Submit for Verification"}
              </Button>
              <Button type="button" variant="outline" onClick={() => navigate(-1)} className="rounded-none"> {/* ADDED rounded-none */}
                Cancel
              </Button>
            </div>
          </form>
