...
  if (loading) {
    // Adjusted loading container for full width
    return <div className="min-h-screen bg-background pb-20 md:pb-0">
        <Header />
        {/* Removed max-w-6xl mx-auto from the loading state container */}
...
      <Header />
      
      {/* *** CHANGE HERE: Removed max-w-6xl mx-auto from main. It now spans full width. *** */}
      <main className="container px-4 py-6">
        
        {/* Added a centered max-width container to restrict content width for readability on large screens. */}
        <div className="max-w-7xl mx-auto">
            
            {/* The grid layout for the image and details */}
            <div className="grid lg:grid-cols-[2fr,1fr] gap-6">
            
            {/* --- Image Carousel Section (Full width of the grid column) --- */}
...
                        {/* Image takes full width of the container, which is the full grid column */}
