...
          style={{ 
            borderBottom: `2px solid ${TEAL_COLOR}`, // Teal bottom border
            marginTop: 0, 
            width: '100%', 
            maxHeight: '600px'
          }}
...
          
          {/* LEFT COLUMN (Description, Activities, Contact) */}
          <div className="w-full space-y-4 sm:space-y-3">
            
            {/* Location/Details section (Moved from right column) */}
            <div>
...
          </div>
          
          {/* RIGHT COLUMN (Booking Card, Action Buttons) */}
...
              </div>
              
              <div className={`${event.date ? 'border-t pt-3 sm:pt-2' : ''}`}>
...
            skipFacilitiesAndActivities={true} // Activities are handled separately in the booking form for events if needed
            itemId={event.id} 
            bookingType="event" 
            hostId={event.created_by || ""} 
